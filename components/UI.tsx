...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary-600 text-white focus:ring-primary-500 border border-primary-600",
    secondary: "bg-primary-50 text-primary-700 focus:ring-primary-500 border border-primary-200",
...
export const Input: React.FC<InputProps> = ({ label, error, helperText, className = '', ...props }) => {
  return (
    <div className="w-full">
      ...
      <motion.input 
        className={`w-full rounded-xl border-2 transition-all duration-200 px-4 py-3 text-sm bg-white placeholder-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 ${
