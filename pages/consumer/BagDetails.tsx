...
const BagDetails: React.FC = () => {
  ...
  if (!bag)
    return (
      <div className="max-w-3xl mx-auto text-center py-20">Bag not found</div>
    );
        ...
        <div className="h-80 md:h-96 bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
          <motion.img
            ...
            onError={(e) => {
              ...
              target.src = `https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&h=800&fit=crop`;
            }}
          />
        ...
        <div className="p-6 md:p-10 space-y-8">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-700 font-semibold">
                    {vendor?.address || "123 Mockingbird Lane"}
                  </p>
          ...
          <div className="pt-6 border-t border-gray-100 flex flex-col md:flex-row items-center gap-4 justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg">
                ...
                <button
                  className="px-3 py-1 text-gray-600 hover:bg-gray-100 disabled:opacity-50"
                  onClick={() =>
                    setQuantity(Math.min(bag.quantity, quantity + 1))
                  }
            ...
            >
              {bag.quantity === 0
                ? "Sold Out"
                : `Reserve for $${(bag.price * quantity).toFixed(2)}`}
            </Button>
          </div>
        </div>
      </Card>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            You are reserving{" "}
            <strong>
              {quantity}x {bag.title}
            </strong>{" "}
            from <strong>{bag.vendorName}</strong>.
          </p>
          <div className="bg-gray-50 p-3 rounded-md text-sm text-gray-700">
            <p className="flex justify-between">
              <span>Total Price:</span>{" "}
              <span className="font-bold">
                ${(bag.price * quantity).toFixed(2)}
              </span>
            </p>
          ...
          <p className="text-xs text-gray-500">
            Payment will be collected at the store. Please show your
            confirmation code upon arrival.
          </p>
